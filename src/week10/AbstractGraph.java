...
// Adjacency lists
	...
	/** Edge inner class inside the week10.week11.AbstractGraph class */
	...
	public Tree dfs(int v) {
		...
		for (int i = 0; i < parents.length; i++)
			parents[i] = -1; // Initialize parent[i] to -1
		// Mark visited vertices (default false)
		boolean[] isVisited = new boolean[vertices.size()];
		List<Integer> searchOrder = new ArrayList();
		// Recursively search
		dfs(v, parents, isVisited, searchOrder);
		// Return the search tree
		return new Tree(v, parents, searchOrder);
	}
