...
public class BST<E extends Comparable<E>> extends AbstractTree<E> implements Cloneable {
	...
	protected void clone(BST<E> newBST, TreeNode<E> root) {
		if (root == null) {
			return;
		}
	...
	public boolean equals(TreeNode<E> root1, TreeNode<E> root2) {
		if (root1 == root2) {
			return true;
		} else if (root1 == null || root2 == null) {
			return false;
		}
		return (root1.element.equals(root2.element) && equals(root1.left, root2.left)
	...
	public void inorderStack(TreeNode<E> root) {
		if (root == null)
			return;
	...
	public void preorderStack(TreeNode<E> root) {
		if (root == null)
			return;
		Stack<TreeNode<E>> stk = new Stack<TreeNode<E>>();
		TreeNode<E> current;
	...
	public void postorderStack(TreeNode<E> root) {
		if (root == null)
			return;
		Stack<TreeNode<E>> stk1 = new Stack<TreeNode<E>>();
		Stack<TreeNode<E>> stk2 = new Stack<TreeNode<E>>();
		TreeNode<E> current;
		stk1.push(root);
